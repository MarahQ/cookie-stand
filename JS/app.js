let Profiles = document.getElementById('Sales');
console.log(Sales);
...
shop.prototype.randomFun = function () {
  ...
  for (let i = 0; i < hour.length; i++) {
    //this.cookies=  (Math.floor(Math.random() * ((this.maxcust - this.mincust + 1) + this.mincust))* this.avgcust);
    this.cookies.push(Math.floor(Math.floor(Math.random() * ((this.maxcust - this.mincust + 1) + this.mincust)) * this.avgcust));
    //push(this.cookies)
